package com.relevanttech.mapping.utils
...
object MapUtils {
    ...
    fun getBikeBitmap(context: Context): Bitmap {
        val bitmap = BitmapFactory.decodeResource(context.resources, R.drawable.ic_bike)
        return Bitmap.createScaledBitmap(bitmap, 50, 100, false)
    }
